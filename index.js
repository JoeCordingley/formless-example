...
(function($PS) {
  ...
  var spec = function (dictMonad) {
      var render = function (v) {
          return Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))()()(Type_Proxy["Proxy"].value)(v.form)), Halogen_HTML_Events.onValueInput(Formless_Action.set(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))()()(Type_Proxy["Proxy"].value)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "age";
              ...
              throw new Error("Failed pattern match at Dogs (line 63, column 17 - line 67, column 60): " + [ v1.constructor.name ]);
