...
(function($PS) {
  ...
  var HandleDogForm = (function () {
      function HandleDogForm(value0) {
          this.value0 = value0;
      };
      HandleDogForm.create = function (value0) {
          return new HandleDogForm(value0);
      };
      return HandleDogForm;
  })();
  var spec = function (dictMonad) {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(Formless_Action.set(new Data_Symbol.IsSymbol(function () {
              return "name";
          }))()()(Type_Proxy["Proxy"].value)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
              return "age";
              ...
              if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof TooHigh) {
                  return "No dog has lived past 30 before";
              };
              throw new Error("Failed pattern match at Dogs (line 61, column 17 - line 65, column 60): " + [ v1.constructor.name ]);
  ...
  var showAge = new Data_Show.Show((function () {
      var $20 = Data_Show.show(Data_Show.showInt);
      var $21 = Data_Newtype.unwrap();
      return function ($22) {
          return $20($21($22));
      };
  })());
  var input = function (dictMonad) {
      return {
          initialInputs: new Data_Maybe.Just(Formless_Transform_Record.wrapInputFields()(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
              return "age";
          ...
          validators: {
              name: Formless_Validation.noValidation(dictMonad),
              age: Formless_Validation.hoistFnE_(dictMonad)(function (str) {
                  ...
                  if (v instanceof Data_Maybe.Just) {
                      ...
                      if (v.value0 > 30) {
                          return new Data_Either.Left(TooHigh.value);
                      };
                      if (Data_Boolean.otherwise) {
                          return new Data_Either.Right(v.value0);
                      };
                  };
                  throw new Error("Failed pattern match at Dogs (line 41, column 34 - line 46, column 41): " + [ v.constructor.name ]);
              })
          }
      };
  };
  var page = function (dictMonadAff) {
      var renderDog = function (dog) {
          return Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "name";
          }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(showAge)))(dog));
      };
      var render = function (dogs) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderDog)(dogs)), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "formless";
          }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(Formless_Component.component(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "name";
              ...
              return "name";
          }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowNil)())())()()()()()()()()()()()()()()()()()(Data_Function["const"](input((dictMonadAff.MonadEffect0()).Monad0())))(spec((dictMonadAff.MonadEffect0()).Monad0())))(Data_Unit.unit)(HandleDogForm.create) ]);
      };
      var handleAction = function (v) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Array.cons(v.value0));
      };
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Dogs.page(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();